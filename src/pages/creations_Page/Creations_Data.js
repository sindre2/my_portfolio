import { imagesCreations } from "./Creations_Images";

export const creationsData = [
  {
    key: 0,
    title: "Skeletor lydbrett",
    image: imagesCreations.skelly,
  ...
  },
  {
    ...
    image: imagesCreations.password,
