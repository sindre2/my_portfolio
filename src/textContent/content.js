export const TEXT = {
  ...
  ABOUT_ME_TEXT: {
    TITLE: "Om Meg",
    PITCH: `
        30 år gammel mann som går på Kodehode for å lære hemmelighetene bak alle disse kattepus videoene. Dvs den hellige digitale treenigheten: HTML, CSS og Javascript. Jeg har også tuklet rundt med React. 
